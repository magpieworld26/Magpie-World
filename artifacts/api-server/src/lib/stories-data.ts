...
export const storiesData: StoryData[] = [
  {
    ...
    description: "A quantum physicist discovers she can send messages to her past self — but every message changes the present in terrifying ways.",
    ...
    coverGradient: "linear-gradient(145deg, #0d4a47 0%, #0a2a2e 60%, #061a25 100%)",
  ...
  },
  {
    ...
    genre: "Dark Fantasy",
    description: "In a world where maps hold magical power, the last map-maker must chart a territory that shouldn't exist — the land of the dead.",
    longDescription: "Maps are power in the Twelve Kingdoms. Whoever draws the borders makes them real. Silas Vane is the last true Cartographer, a dying art in a world consumed by war. When a dying soldier brings him a fragment of a map showing a land beyond death itself, Silas is drawn into a quest that will take him beyond every boundary he thought unbreakable. The dead remember what the living have forgotten — and something in that forgotten land wants to stay buried.",
    coverGradient: "linear-gradient(145deg, #0b2535 0%, #091c2a 50%, #071218 100%)",
  ...
  },
  {
    ...
    description: "A memory-hacker in 2087 Neo-Tokyo uncovers a conspiracy buried in the minds of the city's elite — including her own stolen past.",
    longDescription: "In 2087, memories are currency. Yuki Nakamura hacks minds for a living — retrieving buried secrets, planting convenient fictions, erasing inconvenient truths. When a routine job goes catastrophically wrong, Yuki discovers she's been living inside a fabricated identity. Her true self is locked somewhere in the labyrinthine neural networks of Neo-Tokyo's oligarchy. Hunted by corporate kill-squads and haunted by memories that may not be hers, Yuki must hack the most dangerous system of all: the truth.",
    coverGradient: "linear-gradient(145deg, #1a0a3d 0%, #2a0f5a 40%, #0d062b 100%)",
  ...
  },
  {
    ...
    genre: "Mythic Horror",
    description: "A marine biologist's research vessel vanishes. Months later, she returns alone — with no memory and something ancient in her eyes.",
    ...
    coverGradient: "linear-gradient(145deg, #1a1a0f 0%, #2a2410 50%, #111008 100%)",
  ...
  },
  {
    ...
    description: "A disgraced general returns from exile to find her kingdom on the edge of revolution — and her own name at the center of a prophecy she never asked for.",
    ...
    coverGradient: "linear-gradient(145deg, #3d1205 0%, #6b2208 40%, #c44a10 70%, #e8621a 100%)",
  ...
  },
  {
    ...
    description: "A grief counselor inherits an estate with no windows — only mirrors. And in each mirror, a different version of her dead sister stares back.",
  ...
  },
  {
    ...
    genre: "Space Opera",
    description: "The last generation ship reaches its destination — only to find the planet already colonized. By humanity's descendants. From 400 years in the future.",
  ...
  },
  {
    ...
    description: "A forensic linguist decodes an ancient treaty that was supposed to end a war — and realizes it actually started one that's still being fought today.",
...
export function getInitialStoryNode(storyId: string): { narrativeText: string; choices: Array<{ id: string; text: string; consequence?: string }> } {
  ...
  const openings: Record<string, { narrativeText: string; choices: Array<{ id: string; text: string; consequence?: string }> }> = {
    "echoes-of-tomorrow": {
      ...
      choices: [
        { id: "warn-reyes", text: "Tell Reyes about the message and begin evacuation immediately", consequence: "Trust the warning" },
        { id: "investigate-alone", text: "Hide the message. Run your own diagnostics before making any decisions", consequence: "Verify before acting" },
        { id: "test-the-system", text: "Send a message back through the entanglement — test if the connection is real", consequence: "Engage the paradox" },
        { id: "run-calibration", text: "The message could be a fabrication. Run the tertiary calibration as planned", consequence: "Defy the warning" }
      ]
    },
    "the-last-cartographer": {
      ...
      choices: [
        { id: "hide-the-map", text: "Hide the map fragment in your secret archive. Tell the guard you found nothing on him", consequence: "Protect the secret" },
        { id: "show-wren", text: "Show Wren the fragment. She has fresh eyes — maybe she sees something you don't", consequence: "Seek a second perspective" },
        { id: "study-immediately", text: "Send Wren to stall the guard. Spend every minute studying the fragment while you can", consequence: "Pursue knowledge first" },
        { id: "surrender-it", text: "Surrender the fragment to the guard. If it's real, the Crown should know", consequence: "Play by the rules" }
      ]
    },
    "neon-requiem": {
      ...
      choices: [
        { id: "grab-signature", text: "Grab the architect's neural signature before extracting. The wall is the real job now", consequence: "Follow the thread" },
        { id: "clean-exit", text: "Pull out clean. Take the money. This is above your pay grade", consequence: "Walk away" },
        { id: "crack-the-wall", text: "Try to crack it anyway. Ninety seconds is longer than people think", consequence: "Go deeper" },
        { id: "plant-a-trace", text: "Plant a dormant trace program before extracting — come back when you're better prepared", consequence: "Play the long game" }
      ]
    },
    "whispers-of-the-tide": {
      ...
      choices: [
        { id: "speak-amara", text: "Go to Amara. She was your closest friend on the crew — she deserves the truth first", consequence: "Trust friendship" },
        { id: "speak-government", text: "Meet with the government agent. If there's something wrong with you, you need institutional resources", consequence: "Trust authority" },
        { id: "examine-yourself", text: "Ask for time alone. You need to understand what's happening in your own mind before talking to anyone", consequence: "Look inward" },
        { id: "try-to-leave", text: "Walk out. You're not under arrest. Whatever happened to you isn't their business until it's yours", consequence: "Reclaim autonomy" }
      ]
    },
    "the-iron-crown": {
      ...
      choices: [
        { id: "claim-crown", text: "Put it on. The Iron Crown has never been worn by a woman. It has never been worn by someone the people actually trust. Until now.", consequence: "Seize power" },
        { id: "find-emperor", text: "Find the missing Emperor first. Return the Crown to its rightful owner — then negotiate your own pardon", consequence: "Play kingmaker" },
        { id: "destroy-crown", text: "Destroy the Crown. No one holds power over others through an object. The revolution needs a symbol, not a relic.", consequence: "Burn it all down" },
        { id: "use-as-leverage", text: "Hide it. Use its existence as a bargaining chip with all three factions. Let them come to you.", consequence: "Play all sides" }
      ]
    },
    "garden-of-glass": {
      ...
      choices: [
        { id: "approach-mirror", text: "Walk toward the mirror. Whatever is happening, you need to face it directly", consequence: "Confront the reflection" },
        { id: "answer-phone", text: "Answer the phone. Ground yourself in the real before the house can claim you", consequence: "Stay tethered" },
        { id: "go-inside", text: "Go inside and don't look at the mirror again. Look for rational explanations", consequence: "Seek logic" },
        { id: "leave-now", text: "Get back in the car and drive away. Some inheritances shouldn't be accepted", consequence: "Retreat" }
      ]
    },
    "children-of-the-void": {
      ...
      choices: [
        { id: "accept-approach", text: "Follow the approach vector and make formal first contact. Transparency is the only way forward", consequence: "Trust the welcome" },
        { id: "hold-position", text: "Hold position. Gather intelligence before anyone goes anywhere. This could be a trap", consequence: "Proceed with caution" },
        { id: "ask-direct", text: "Transmit a direct question: who decided to report us as lost, and why?", consequence: "Demand answers" },
        { id: "send-shuttle", text: "Send an unmanned probe with the shuttle crew on standby. Verify the invitation before committing", consequence: "Test the waters" }
      ]
    },
    "the-salt-covenant": {
      ...
      choices: [
        { id: "call-daughter", text: "Call his daughter first. Whatever this is, family comes before scholarship", consequence: "Prioritize family" },
        { id: "call-unknown", text: "Call the unknown international number. They already know he has it", consequence: "Face the unknown" },
