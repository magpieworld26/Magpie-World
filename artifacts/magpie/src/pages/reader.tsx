    ...
    try {
      ...
      const msg =
        err instanceof Error
          ? err.message
          : "Something went wrong generating the next scene.";
      if (
        ...
        <>
          {(() => {
            const freeWillWordCount = freeWillInput.trim()
              ? freeWillInput.trim().split(/\s+/).filter(Boolean).length
              : 0;
                  ...
                  <textarea
                    ...
                    onKeyDown={(e) => {
                      if (e.key === "Enter" && !e.shiftKey) {
                        e.preventDefault();
                        if (!freeWillOverLimit) handleFreeWillSubmit();
                      }
                    }}
                    ...
                    onFocus={(e) => {
                      e.currentTarget.style.borderColor = freeWillOverLimit
                        ? "rgba(255,80,80,0.7)"
                        : "rgba(0,229,200,0.5)";
                    }}
                    onBlur={(e) => {
                  ...
                  >
                    <span
                      style={{
                        ...
                        fontFamily: "'Barlow Condensed', sans-serif",
                        letterSpacing: "1px",
                        color: freeWillOverLimit
                          ? "rgba(255,80,80,0.9)"
                          : "rgba(0,229,200,0.4)",
                        transition: "color 0.2s",
                      }}
                    >
                      {freeWillWordCount} / 50 words
                      {freeWillOverLimit ? " — too long" : ""}
                    </span>
                    <button
              ...
              >
                ...
                >
                  <div
                    style={{
                      height: "100%",
                      width: `${Math.min(100, (nodes.length / 20) * 100)}%`,
                          ...
                          style={{
                            ...
                            background:
                              node.id === currentNode.id
                                ? "#00e5c8"
                                : i < nodes.indexOf(currentNode)
                                  ? "#00e5c8"
                                  : "rgba(255,255,255,0.2)",
                            boxShadow:
                              node.id === currentNode.id
                                ? "0 0 10px rgba(0,229,200,0.8)"
                                : undefined,
                          }}
                        />
                        {i < nodes.length - 1 && (
                      ...
                      <div style={{ paddingBottom: "16px" }}>
                        ...
                        >
                          {node.choiceMade ? (
                            ...
                            >
                              "{node.choiceMade.slice(0, 40)}
                              {node.choiceMade.length > 40 ? "..." : ""}"
                            </span>
                          ) : (
                            <span
                              style={{
