  ...
  const handleForgotSubmit = useCallback(
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        setForgotOpen(false);
        setLocation(
          `/verify-otp?email=${encodeURIComponent(forgotEmail)}&type=recovery`,
        );
      } catch (err: unknown) {
        setForgotFeedback({
          type: "error",
      ...
      >
        <div
          style={{
            ...
            height: "700px",
            background:
              "radial-gradient(circle, rgba(104,230,197,0.08) 0%, transparent 70%)",
            top: "-180px",
            left: "-180px",
            borderRadius: "50%",
          }}
        ...
        <div
          style={{
            ...
            height: "600px",
            background:
              "radial-gradient(circle, rgba(79,152,216,0.08) 0%, transparent 70%)",
            bottom: "-120px",
            right: "-120px",
            borderRadius: "50%",
          }}
        ...
        <div style={{ width: "100%", maxWidth: "480px" }}>
          <div
            style={{
              ...
              boxShadow:
                "0 24px 64px rgba(0,0,0,0.45), 0 0 0 1px rgba(104,230,197,0.05)",
            }}
          >
            ...
            <form onSubmit={handleSubmit}>
              ...
              >
                By continuing you agree that you are 13 or above and agree to
                the{" "}
                <a
                  href="/terms-of-service.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ color: "#68e6c5", textDecoration: "none" }}
                >
                  Terms of Service
                </a>{" "}
                and{" "}
      ...
      >
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            style={{ color: "#253a4f", textDecoration: "none" }}
          >
            Privacy
          </a>{" "}
          ·{" "}
        ...
        >
          <div
            ...
            style={{
              ...
              backdropFilter: "blur(20px)",
              boxShadow:
                "0 24px 64px rgba(0,0,0,0.55), 0 0 0 1px rgba(104,230,197,0.05)",
            }}
          >
            <h2
              style={{
            ...
            <form onSubmit={handleForgotSubmit}>
              ...
              <button
                type="submit"
                disabled={
                  forgotLoading || (blockedUntil !== null && countdown > 0)
                }
                style={{
                  width: "100%",
                  background: "linear-gradient(90deg, #6be7c5, #4ea7d8)",
